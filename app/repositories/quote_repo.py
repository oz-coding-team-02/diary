...
class QuoteRepository:
    @staticmethod
    async def get_random_quote_one() -> Optional[Quote]:
    ...
    @staticmethod
    async def get_bookmark_or_none(user_id: int, quote_id: int) -> Optional[Bookmark]:
    ...
    @staticmethod
    async def get_bookmarked_quotes_for_user(user_id: int) -> list[Bookmark]:
